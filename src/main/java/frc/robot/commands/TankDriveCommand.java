...
/** FILE DESCRIPTION:
 *  This class calls the functions defined in DriveSubsystem, detailing
 *  how they will be used with the joystick inputs provided by RobotContainer.
 */

public class TankDriveCommand extends CommandBase {

  /** [TODO #11] create instance variable driveSubsystem of type DriveSubsystem and 
...
public TankDriveCommand(DriveSubsystem driveSubsystem,
    ...
    /** [TODO #12] use keyword "this" to set the instance variables speedLeftFunction 
  ...
  public void execute() {
    ...
    /** [TODO #13] get the current y-value of the right joystick and store it in variable
     *  rightSpeed of type double
     */

    /** [TODO #14] multiply leftSpeed and rightSpeed by one half and store the results
     *  in two doubles leftMotorOutputs and rightMotorOutputs
     */
    
    /** [TODO #15] use the setLeftMotorOutputs() and setRightMotorOutputs() methods from
  ...
  public void end(boolean interrupted) {
    // [TODO #16] set motor outputs on both sides to zero and put the motors in coast mode
  }
